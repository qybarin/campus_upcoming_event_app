...
* To help organizers manage event details more efficiently.
...
```bash
git clone https://github.com/qybarin/campus_upcoming_event_app.git
```

2. Open the project using **Android Studio**.

3. Open the `Project2` folder.
...
* Add event approval by admin
* Add notification for upcoming events
* Add QR code attendance system
